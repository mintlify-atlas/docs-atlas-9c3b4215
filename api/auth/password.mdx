---
title: "Change and reset passwords in ServiciosYa API"
sidebarTitle: "Password"
description: "Three password endpoints: change password for authenticated users, and a two-step OTP-based reset flow for unauthenticated users who forgot their credentials."
---
...
<ResponseField name="message" type="string">
  `"Tu contraseña fue actualizada."` on success.
</ResponseField>
