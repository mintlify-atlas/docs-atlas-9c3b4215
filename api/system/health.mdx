...
sidebarTitle: "Health"
description: "Two public health endpoints for liveness and readiness probes. /health/live always returns 200; /health/ready checks database connectivity and storage access."
---
