...
sidebarTitle: "Status"
description: "PUT /api/servicerequests/{id}/status changes request state. Customers can cancel from SOLICITADO; admins manage the full lifecycle including cancellation reminders."
---
